...
<head>
    ...
    <!-- Title -->
    <title>Casa SPA Paraty | Aluguel de Casa Inteira com Hidromassagem</title>
    
    <!-- SEO Meta -->
    <link rel="canonical" href="https://site-casa-spa.vercel.app/" />
    <meta name="description" content="Descubra a Casa SPA Paraty, um refúgio exclusivo entre o verde e o mar em Corumbê, Paraty (RJ). Casa inteira com hidromassagem para até 6 hóspedes. Reserve agora!" />
    <meta name="keywords" content="Casa SPA Paraty, Hospedagem Paraty, Aluguel temporada Paraty, Casa com SPA, Casa Corumbê" />
    ...
    <meta property="og:title" content="Casa SPA Paraty | Aluguel de Casa Inteira com Hidromassagem">
    <meta property="og:description" content="Descubra a Casa SPA Paraty, um refúgio exclusivo entre o verde e o mar em Corumbê, Paraty (RJ). Casa inteira com hidromassagem para até 6 hóspedes. Reserve agora!">
    ...
    <meta property="twitter:title" content="Casa SPA Paraty | Aluguel de Casa Inteira com Hidromassagem">
    <meta property="twitter:description" content="Descubra a Casa SPA Paraty, um refúgio exclusivo entre o verde e o mar em Corumbê, Paraty (RJ). Casa inteira com hidromassagem para até 6 hóspedes. Reserve agora!">
    ...
    <script type="application/ld+json">
    {
      ...
      "description": "Um refúgio particular entre o verde e o mar. Casa inteira em Paraty para viver sem pressa, com hidromassagem, privacidade e espaço para compartilhar.",
      "url": "https://site-casa-spa.vercel.app/",
      "telephone": "+5524998144912",
      "image": "https://site-casa-spa.vercel.app/images/mf-images/fachada-01.webp",
      "address": {
        "@type": "PostalAddress",
        "streetAddress": "Corumbê",
...
<body>
                                    ...
                                    <div class="collapse navbar-collapse clearfix show" id="pbmit-menu">
                                        <div class="pbmit-menu-wrap">
                                            ...
                                            <ul class="navigation clearfix">
                                                ...
                                                <li class="">
                                                    <a href="contact-us.html" style="color:var(--casa-champagne)">Reservar</a>
                                                </li>
                                            </ul>
        ...
        <div class="pbmit-title-bar-content">
          <div class="pbmit-title-bar-content-inner">
            <div class="pbmit-tbar-title">
              <h1 class="pbmit-tbar-title">Reservar</h1>
            </div>
          </div>
        </div>
      </div>
  ...
  <footer id="site-footer" class="footer-container">
                                    <!-- AEO / Factual Text -->
                                    <div class="container pt-4 pb-2" style="border-bottom: 1px solid rgba(255,255,255,0.1);">
                                        <div class="row">
                                            <div class="col-12 text-center" style="font-size: 0.85rem; color: #a4b3a4;">
                                                <p class="mb-0">A Casa SPA Paraty é uma casa de 3 quartos e 3 banheiros para até 6 hóspedes, localizada no bairro Corumbê, em Paraty (RJ), com hidromassagem privativa e cozinha completa.</p>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="footer-row">
                                            ...
                                            <div class="footer-column">
                                                ...
                                                <div class="footer-logo">
                                                    <img loading="lazy" src="images/brand/logo-casa-spa-branca.webp" alt="Casa SPA Paraty" />
                                                </div>
                                                <ul>
